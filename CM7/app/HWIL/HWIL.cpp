...
namespace CFG {
  ...
  constexpr double kDryMass = 31.5;
  ...
  constexpr double kCgX = 0.0, kCgY = -0.00, kCgZ = -0.25830;
...
void HWIL::initialize()
{
  ...
  double EulerRPY[3] = {0.09, 0.0, 0.0};
